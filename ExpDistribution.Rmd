---
title: "Statistical Inference - The exponential distribution"
author: "Sabank"
date: "April 25, 2015"
output:
  html_document:
...
sm <- 1 / lambda
```
* approximation of sample mean = `r asm`

* theoretical sample mean = `r sm`
...
sv <- (1 / lambda)^2
```
* approximation of sample variance = `r asv`

* theoretical sample variance = `r sv`
